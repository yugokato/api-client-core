"""Unit tests for `api_client_core._common.discovery`"""
...
from api_client_core._common.discovery import (
    discover_clients,
    discover_resources,
    endpoints_for,
...
from ..tests_cli.conftest import CliTestClient, GadgetsAPI, WidgetsAPI
