...
import api_client_core.core.endpoints.endpoint_func.endpoint_func as _endpoint_func_module
...
from api_client_core.core.endpoints import AsyncEndpointFunc, SyncEndpointFunc, endpoint
from api_client_core.core.endpoints.executors import AsyncExecutor, SyncExecutor
