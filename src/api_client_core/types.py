...
class _QualNameReprMeta(type):
    """Metaclass whose repr displays only the class's qualified name.

    Intended for runtime-generated classes whose synthetic module names would otherwise produce misleading
    `<class 'module.Name'>` representations.
    """
...
class EndpointModel(DataclassModel, metaclass=_QualNameReprMeta):
